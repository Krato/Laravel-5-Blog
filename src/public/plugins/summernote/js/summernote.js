...
(function (factory) {
  ...
  var Style = function () {
    ...
    this.current = function (rng, target) {
      ...
      styleInfo['font-bold'] = document.queryCommandState('bold') ? 'strong' : 'normal';
      styleInfo['font-italic'] = document.queryCommandState('italic') ? 'emphati' : 'normal';
  ...
  var EventHandler = function () {
    ...
    var hToolbarAndPopoverClick = function (event) {
      ...
      if ($btn.length) {
        ...
        if ($.inArray(eventName, ['bold', 'italic']) !== -1) {
